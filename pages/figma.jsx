...
export default function Home() {
    ...
    return (
        ...
        <main className={`px-8 flex-col items-center justify-center pt-10 pb-8`}>
            <div className='w-full py-10'>
                ...
                <div className="flex items-center justify-center">
                    <span>
                        <svg className="w-8 h-8 dark:text-white" fill="none" stroke="#47d147" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                        </svg>
                    </span>
                    <span className="text-2xl font-semibold ml-2">Figma Connected</span>
                </div>
                {
                    files?.length ? (
        ...
        <footer className={`flex flex-1 p-4 border-t bg-white border-t-gray-300 items-center justify-center fixed bottom-0 left-0 w-full`}>
            <a
